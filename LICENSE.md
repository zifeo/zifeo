...
- text and images are available under the
  [Creative Commons Attribution-ShareAlike 4.0
  license](https://creativecommons.org/licenses/by-sa/4.0/), unless stated
  otherwise
- source code is available under the Mozilla Public License 2.0 (see below)
